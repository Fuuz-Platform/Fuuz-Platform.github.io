...
export const NAMED = [
  ...
  { name: 'HTTP', category: 'Technology Connectors', logo: null, description: 'HyperText Transfer Protocol.' },
  ...
  { name: 'OpenAI Chat', category: 'AI', logo: s3('e86501cd-80b4-46ea-97c8-33d31cfef632'), description: 'A connector to interact with OpenAI Chat GPT models via the OpenAI API.' },
  ...
  { name: 'Salesforce', category: 'CRM', logo: s3('44ff6253-ca43-4429-955a-2907803178b8'), description: 'A customer relationship management solution that brings companies and customers together.' },
...
export const LLMS = [
  ...
  { name: 'OpenAI (GPT-4, o-series)', tag: null, logo: s3('e86501cd-80b4-46ea-97c8-33d31cfef632'),
    desc: '<strong>OpenAI Chat</strong> — a purpose-built named connector, API key / bearer token auth. Token-based pricing; the Realtime API\'s WebSocket transport isn\'t reachable from the cloud connector. <a href="./openai-chat/">Full API reference &amp; schema explorer &rarr;</a>' },
